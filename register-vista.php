       ...
       <div class="col-sm-8 main-section">
           ...
           <div class="modal-content">
               ...
               <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" class="col-12 form" method="post">
                   ...
                   <div class="form-group" id="enve-group">
                   ...
                   <!--CODIGO DE ERROR USUARIO YA EXISTE Y CONTRASEÑA NO COINCIDEN PHP PARA REGISTRO-->
                   <?php if(!empty($error)): ?>
                   <div class="mensaje">
                     <?php echo $error; ?>
                   </div>
                   ...
                   <!--CONTENEDOR DE BOTON-->
                   <button class="btn text-white "> <i class="fas fa-sign-in-alt"></i> REGISTRARSE</button>
                   <!--fin-->
